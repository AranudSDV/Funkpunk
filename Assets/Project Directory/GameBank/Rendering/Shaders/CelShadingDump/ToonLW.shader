	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 worldPosValue184_g17 = WorldPosition;
				float3 WorldPosition128_g17 = worldPosValue184_g17;
				float4 screenPos = IN.ase_texcoord7;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g17 = (ase_screenPosNorm).xy;
				float2 ScreenUV128_g17 = ScreenUV183_g17;
				float3 worldNormalValue185_g17 = worldNormal78;
				float3 WorldNormal128_g17 = worldNormalValue185_g17;
				float3 localAdditionalLightsLambert14x128_g17 = AdditionalLightsLambert14x( WorldPosition128_g17 , ScreenUV128_g17 , WorldNormal128_g17 );
				float3 temp_output_160_0 = localAdditionalLightsLambert14x128_g17;
...
ASEEND*/
//CHKSM=626345BB1433A145B5336F578B86B305B5CA769F