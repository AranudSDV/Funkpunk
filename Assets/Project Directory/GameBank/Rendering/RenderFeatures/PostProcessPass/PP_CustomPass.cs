...
[System.Serializable]
public class PP_CustomPass : ScriptableRenderPass
{
    ...
    private cs_BloomHiJack m_BloomEffect;
    ...
    public PP_CustomPass(Material bloomMaterial, Material compositeMaterial)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        m_BloomEffect = stack.GetComponent<cs_BloomHiJack>();

        CommandBuffer cmd = CommandBufferPool.Get();

        using (new ProfilingScope(cmd, new ProfilingSampler("Custom Post Process")))
        {
            ...
            m_compositeMaterial.SetFloat("_Cutoff", m_BloomEffect.Cutoff.value);
